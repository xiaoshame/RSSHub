...
// /informedainews
router.get('/informedainews/zh-Hans/docs/:type?', lazyloadRouteHandler('./routes/informedainews/index'));

// xueqiu
router.get('/xueqiu/hots', lazyloadRouteHandler('./routes/xueqiu/hots'));
router.get('/xueqiu/today', lazyloadRouteHandler('./routes/xueqiu/today'));

// eastmoney
router.get('/eastmoney/ttjj/:uid?', lazyloadRouteHandler('./routes/eastmoney/ttjj/user'));
router.get('/eastmoney/barrons', lazyloadRouteHandler('./routes/eastmoney/barrons/index'));

// guozaoke
router.get('/guozaoke/default', lazyloadRouteHandler('./routes/guozaoke/index'));

// nikkei
router.get('/nikkei/cn', lazyloadRouteHandler('./routes/nikkei/cn/index'));

// cnn fear
router.get('/cnn/fear', lazyloadRouteHandler('./routes/cnn/fear/index'));

// jandan
router.get('/jandan', lazyloadRouteHandler('./routes/jandan/index'));

// boyouquan
router.get('/boyouquan', lazyloadRouteHandler('./routes/boyouquan/index'));

// linux.do
router.get('/linuxdo/latest', lazyloadRouteHandler('./routes/linuxdo/index'));
// mckinsey
// router.get('/mckinsey/cn', lazyloadRouteHandler('./routes/mckinsey/cn/index'));
// Deprecated: DO NOT ADD ANY NEW ROUTES HERE
